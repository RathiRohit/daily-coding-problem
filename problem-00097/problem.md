...
`Advent fo Code` | [link](https://adventofcode.com/2020/day/11#part2)
...
seats, consider the first seat in each of those eight directions.
...
takes five or more visible occupied seats for an occupied seat
to become empty (rather than four or more from the previous rules).
...
area reaches equilibrium. Once this occurs, you count `26`
occupied seats.
