...
`Advent fo Code` | [link](https://adventofcode.com/2020/day/20)
...
array. The camera array consists of many cameras; rather than
...
tiles are both oriented correctly. Tiles at the edge of the image
also have this border, but the outermost edges won't line up with
any other tiles.
...
tiles from the example above, you get
